...
| [preventReOpenOnClose](https://codesandbox.io/s/github/Typeform/embed-demo/tree/main/demo-html/prevent-reopen-on-close-js) | boolean                     |                                                                                                                                                                                                                                                                                                        | `false`                                                       |
...
| [buttonAlign](https://codesandbox.io/s/github/Typeform/embed-demo/tree/main/demo-html/sidetab-customized-html)             | `top` / `center` / `bottom` | customize button posi`tion relative to form iframe (sidetab only)                                                                                                                                                                                                                                      | `center`                                                      |
