...
| [disablePartialResponses](https://codesandbox.io/s/github/Typeform/embed-demo/tree/main/demo-html/disable-partial-responses) | boolean            | do not store or load answers from local storage, does not affect previously stored answers                                                                                                                                                                                                             | `false`                                                       |
