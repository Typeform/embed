...
| hidden                 | object           | [hidden fields](/embed/hidden-fields) to be passed to the form                                                                                                                                                    | `undefined`                                                   |
...
| onReady                | function         | fires when the form is loaded (see [callbacks](/embed/callbacks))                                                                                                                                                 | `undefined`                                                   |
| onSubmit               | function         | fires when user submits the form (see [callbacks](/embed/callbacks))                                                                                                                                              | `undefined`                                                   |
| onClose                | function         | fires when the form is closed (when opened in modal window)                                                                                                                                                       | `undefined`                                                   |
| onQuestionChanged      | function         | fires when user navigates between form questions (see [callbacks](/embed/callbacks))                                                                                                                              | `undefined`                                                   |
...
| lazy                   | boolean          | enable lazy loading (for widget only), typeform starts loading when user scrolls to it                                                                                                                            | `false`                                                       |
